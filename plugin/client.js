  ...
  apply(ctx) {
    ...
    function FileViewer(props) {
      ...
      if (loading) {
        ...
        body = React.createElement('div', { className: 'dsh-viewer-body' }, data.content)
      } else {
      ...
      return React.createElement('div', { className: 'dsh-sidebar-panel' },
        ...
        body,
        data ? React.createElement('div', { className: 'dsh-viewer-meta' }, data.lines + ' 行 · ' + data.bytes + ' 字节 · ' + data.path) : null,
      )
    }
